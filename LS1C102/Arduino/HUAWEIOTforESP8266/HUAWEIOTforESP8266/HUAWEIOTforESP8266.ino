...
#define WIFI_SSID "OPPO Find X6"    //wifi名称
#define WIFI_PASSWORD "km.#@%20040130"  //wifi密码
//MQTT三元组
#define ClientId "6679222d6bc31504f07056c9_esp8266_0_0_2024062416"
#define Username "6679222d6bc31504f07056c9_esp8266"
#define Password "ea1c8d111902e3af679357deedfc4515e637abdb5c7fb3c160f92a3c7da9a794"

#define MQTT_Address "75d17e7ce2.st1.iotda-device.cn-north-4.myhuaweicloud.com"
#define MQTT_Port 1883
#define Iot_link_MQTT_Topic_Report "$oc/devices/6679222d6bc31504f07056c9_esp8266/sys/properties/report"
#define Iot_link_MQTT_Topic_Commands "$oc/devices/6679222d6bc31504f07056c9_esp8266/sys/messages/down"
...
void protocolJSON(unsigned char JsonData[]) {
  ...
  JsonObject& services_0 = services.createNestedObject();
  services_0["service_id"] = "temp_humidity";
  ...
  JsonObject& services_0_properties = services_0.createNestedObject("properties");
    ...
    if (JsonData[0] == 0x55) {
      if (JsonData[1] == 0xAA) {
        ...
        services_0_properties["校正热载荷"] = total_data;
        memset(total_data, 0, sizeof(total_data));
        delay(50);

        sprintf(total_data, "%d", JsonData[3]);
        services_0_properties["车间湿度"] = total_data;
        memset(total_data, 0, sizeof(total_data));
        delay(50);
      }
    }
